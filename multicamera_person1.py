...
GALLERY_DIR = "gallery"
CAMERA_SOURCES = ["http://192.168.1.24:8080/video",0]   # 👈 Add your camera sources or videos here
...
class MultiCamReID:
    def __init__(self, sources: List):
        ...
        self.pending_body, self.pending_face = {}, {}
    ...
    def show_all(self):
        """Combine frames from all cameras into one view"""
        while not self.stop_flag:
            with self.lock:
